...
// Reads/writes patient state to App-level via props.

function EPLPathway({ state, setState, onAsk }) {
  const s = state;
  ...
  return (
    <>
      ...
      >
        ...
        {s.rhStatus === "negative" && (
          <Recommendation
            ...
            body={<><strong>Memorial Regional</strong> stocks <strong>300mcg IM</strong> (mini-dose 50mcg discontinued 2024). Administer within 72h of bleeding for any EPL ≥7 weeks GA. Consider for any first-trimester bleeding per local protocol.</>}
            citeIds={["smfm-rh-2024","yukti-local-rh"]}
            tags={[{kind:"local", label:"Locally adapted dose"}]}
            onAsk={() => onAsk("What is Memorial Regional's RhoGAM protocol for this patient?")}
          />
        )}
      </Section>
      ...
      <Section
        ...
        sub="Per Memorial Regional pathway."
      >
